...
<h4 align="center"><u>Brands List</u></h4>
<br>
</p>
...
<tbody>
	<tr height="20">
		<td scope="col" class="listViewThS1" nowrap>Brand ID</td>
		<td scope="col" class="listViewThS1" nowrap>Brand Name</td>
	...
	?>
    	...
    	<tr height="20">
    		<td scope="row" class="oddListRowS1" bgcolor="#ffffff" align="left" valign="top"><span sugar="sugar0b"><?php echo $row->brandID ?></span></td>
    		<td scope="row" class="oddListRowS1" bgcolor="#ffffff" align="left" valign="top"><span sugar="sugar0b"><?php echo $row->brandName ?></span></td>
    		<td scope="row" class="oddListRowS1" bgcolor="#ffffff" align="left" valign="top"><span sugar="sugar0b"><?php echo $row->brandDesc ?></span></td>
