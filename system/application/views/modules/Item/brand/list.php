<form name="frmFilter" id="frmFilter" method="POST" action="index.php?brand/show">
...
<tbody>
	<tr>
		<td scope="col" class="listViewThS1" nowrap><a class="listViewThLinkS1" href="javascript: sorting('brandID');" />Brand ID 
		<?php 
		if ($sortby=="brandID") {
		?>
			<img 
		...
		<td scope="col" class="listViewThS1" nowrap><a class="listViewThLinkS1" href="javascript: sorting('brandName');" />Brand Name
		<?php 
		if ($sortby=="brandName") {
		?>
			<img 
		...
		<td scope="col" class="listViewThS1" nowrap><a class="listViewThLinkS1" href="javascript: sorting('brandDesc');" />Description
		<?php 
		if ($sortby=="brandDesc") {
		?>
			<img 
	...
	<tr height="20" id="filters" style="display: none">
		...
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="brandName" id="brandName" size="35" value="<?php echo $brandName ?>" /></td>
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1">&nbsp;</td>
	...
	?>
    	<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#DEEFFF', '');" height="20">
    		...
    		align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?brand/view/<?php echo $row->brandID; ?>" class="listViewTdLinkS1"><?php echo $row->brandID; ?></a></span></td>
    		
    		<td scope="row" class="oddListRowS1" bgcolor="#ffffff"
    		align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?brand/view/<?php echo $row->brandID; ?>" class="listViewTdLinkS1"><?php echo $row->brandName; ?></a></span></td>
    		
    		<td scope="row" class="oddListRowS1" bgcolor="#ffffff"
    		align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?brand/view/<?php echo $row->brandID; ?>" class="listViewTdLinkS1"><?php echo $row->brandDesc; ?></a></span></td>
    		
    		<td scope="row" class="oddListRowS1" bgcolor="#ffffff" colspan="2"
    		align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?brand/view/<?php echo $row->brandID; ?>" class="listViewTdLinkS1">
    		<?php if($row->status==1) {
    				echo "Active"; 
    			} else {
	...
	<tr>
		...
		<td height="20" scope="col" colspan="4" align="right" class="listViewThS1" nowrap>
		<div align="right">
		Number of Records 
		...
		<input type="image" class="button" name="cmdPrint" id="cmdPrint" value="Print" src="images/printer.png" onclick="return popUp('index.php?brand/printlist/<?php echo $this->uri->segment(3); ?>');"/>
		</div>
		</td>
	</tr>
</tbody>
