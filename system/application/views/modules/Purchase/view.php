<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdcancel" type="button" id="cmdcancel" value="Delivery Receipt" />
    <input class="button" name="cmdcancel" type="button" id="cmdcancel" value="Invoice" />
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
     <tr>
	     <th class="tabDetailViewDL" colspan="4" align="left"><h4 class="dataLabel">Purchase Order </h4></th>
	 </tr>
    <tr>
        <td class="tabDetailViewDL" width="100"><slot>Vessel :</slot></td>
        <td class="tabDetailViewDF" width="250"><slot> MV HOEGH SYDNEY</slot></td>
        <td class="tabDetailViewDL" width="100"><slot>Department :</slot></td>
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td class="tabDetailViewDL" width="100"><slot>PO No. :</slot></td>
        <td class="tabDetailViewDF" width="250"><slot> 	1001</slot></td>
        <td class="tabDetailViewDL" width="100"><slot>PO No. :</slot></td>
        <td class="tabDetailViewDF"><slot> 	1001</slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL"><slot>Supplier :</slot></td>
        <td class="tabDetailViewDF"><slot> CHUGOKU MARINE PAINTS</slot></td>
        <td class="tabDetailViewDL"><slot>Issue Date</slot></td>
        <td class="tabDetailViewDF"><slot> October 20, 2010</slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL"><slot>Contact :</slot></td>
        <td class="tabDetailViewDF"><slot> 434-3434</slot></td>
        <td class="tabDetailViewDL"><slot>Department</slot></td>
        <td class="tabDetailViewDF"><slot> DECK Department</slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL"><slot>Tel/Mail :</slot></td>
        <td class="tabDetailViewDF"><slot> &nbsp;</slot></td>
        <td class="tabDetailViewDL"><slot>Place :</slot></td>
        <td class="tabDetailViewDF"><slot> &nbsp;</slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL"><slot>ETA/D Port :</slot></td>
        <td class="tabDetailViewDF"><slot> &nbsp;</slot></td>
...
<tbody>
	...
	<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
        ...
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="center" valign="top">10.00</td>
        
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="right" valign="top">100.00</td>
	...
	<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
        ...
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="center" valign="top">5.00</td>
        
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="right" valign="top">300.00</td>
	...
	<tr>
		<td colspan="9" height="1" class="listViewHRS1"></td>
	</tr>
	<?php 
	for($i=1; $i<=3; $i++) {
	?>
	...
	<tr height="20">
        ...
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="left" valign="top">Sub Ttl:</td>
        
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="right" valign="top">400.00</td>
	...
	<tr height="20">
        ...
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="left" valign="top">% Disc</td>
        
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="right" valign="top">50.00</td>
	...
	<tr height="20">
        ...
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="left" valign="top">Delivery Ch:</td>
        
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="right" valign="top">0.00</td>
	...
	<tr height="20">
        ...
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="left" valign="top"><b>Total (USD):</b></td>
        
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="right" valign="top"><b>350.00</b></td>
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td class="tabDetailViewDL" width="100" nowrap><slot>Arranged By :</slot></td>
        <td class="tabDetailViewDF"><slot>Nicanor B. Cunado</b></slot></td>
    </tr>
</table>
