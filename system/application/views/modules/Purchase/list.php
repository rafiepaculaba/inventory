<form name="frmFilter" id="frmFilter" method="POST" action="index.php?purchase/show">
...
<tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap><a class="listViewThLinkS1" href="#" /><div align="center">Status</div></a></td>
	...
	<tr height="20" id="filters" style="display: none">
		...
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1" align="center">&nbsp;</td>	
    ...
    <tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
    	<td scope="row" 
            ...
            align="left" valign="top"><span sugar="sugar0b"><a href="index.php?purchase/view" class="listViewTdLinkS1">1001   </a></span></td>
    	
    	<td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
            align="left" valign="top"><span sugar="sugar0b"><a href="index.php?purchase/view" class="listViewTdLinkS1">10/28/2010</a></span></td>
    	...
    	<td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
            align="left" valign="top"><span sugar="sugar0b"><a href="index.php?purchase/view" class="listViewTdLinkS1">MV HOEGH SYDNEY   </a></span></td>
    
    	<td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
            align="left" valign="top"><span sugar="sugar0b"><a href="index.php?purchase/view" class="listViewTdLinkS1">Store & Supplies   </a></span></td>
    
    	<td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
            align="left" valign="top"><span sugar="sugar0b"><a href="index.php?purchase/view" class="listViewTdLinkS1">Paint   </a></span></td>
    
    	<td scope="row"
            class="oddListRowS1" bgcolor="#ffffff" 
    	align="right" valign="top"><span sugar="sugar0b"><a href="index.php?purchase/view" class="listViewTdLinkS1">400.00</a></span></td>
    	
    	<td scope="row"
            class="oddListRowS1" bgcolor="#ffffff" 
    	align="center" valign="top"><span sugar="sugar0b"><a href="index.php?purchase/view" class="listViewTdLinkS1">Pending</a></span></td>
	...
	<tr>
		<td height="20" scope="col" class="listViewThS1" colspan="4" nowrap>
		<?php 
		echo "Total Records: 1";
		?>
		</td>
		
		<td height="20" colspan="5" scope="col" align="right" class="listViewThS1" nowrap>
		<div align="right">
		Number of Records 
