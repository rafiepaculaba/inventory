<table width="100%" border="0">
  <tr>
    ...
    <?php
        if ($rec->rstatus==1) {
	    	if ($roles['edit']) { ?>
		    	<!--<input class="button" name="cmdedit" type="button" id="cmdedit" value="  Edit  " onclick="window.location='index.php?report/edit/<?php echo $rec->cashReportID; ?>';" />-->
		    <?php 	
	    	} 
		    
		    if ($roles['confirm']) { ?>
				<input class="button" name="cmdconfirm" type="button" id="cmdconfirm" value=" Cash Count " onclick="confirmRecord('index.php?report/cashcount/create/<?php echo $rec->cashReportID; ?>');" />
			<?php 
		    } 
			if ($roles['delete']) { ?>
				<input class="button" name="cmddelete" type="button" id="cmddelete" value="   Delete  " onclick="deleteRecord('<?php echo $rec->cashReportID; ?>');" />
		<?php 
			} 
        } else {
        	?>
        	<input class="button" name="cmdprint" type="button" id="cmdprint" value="   Print   " onclick="popUp('index.php?report/print_report/<?php echo $rec->cashReportID; ?>');" />
        	<?php
        }
	?>
  </tr>
	    ...
	    <tr>
	        <td width="50%" valign="top">
				...
				<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
				    ...
				    <tr>
				        <td class="tabDetailViewDL"><slot>Personal Drawings Pymt</slot></td>
				        <td class="tabDetailViewDF" align="right"><slot><?php echo number_format($rec->personal_drawings_pymt,2) ?></slot></td>
				        <td class="tabDetailViewDF" align="right"><slot>&nbsp;</slot></td>
				        <td class="tabDetailViewDF"><slot>&nbsp;</slot></td>
				    </tr>
				     <tr>
				    ...
				    <!--<tr>
				        ...
				        <td class="tabDetailViewDF" align="right"><slot><?php echo number_format($rec->deposits2,2) ?></slot></td>
				        <td class="tabDetailViewDF" align="right"><slot>&nbsp;</slot></td>
				        <td class="tabDetailViewDF"><slot>&nbsp;</slot></td>
				    </tr>
				    <tr>
				        <td class="tabDetailViewDL" width="130"><slot>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3rd Deposit</slot></td>
				        <td class="tabDetailViewDF" align="right"><slot><?php echo number_format($rec->deposits3,2) ?></slot></td>
				        <td class="tabDetailViewDF" align="right"><slot>&nbsp;</slot></td>
				        <td class="tabDetailViewDF"><slot>&nbsp;</slot></td>
				    </tr>-->
				    <tr>
				    ...
				    <tr>
				        ...
				        <td class="tabDetailViewDF" align="right"><slot><?php echo number_format($rec->personal_drawings,2) ?></slot></td>
				...
				<tbody>
		    		...
		    		<tr height="20">
			    		...
			    		$cleft = $cashcount->cashCounted - abs($cashcount->cashReported);
...
function confirmRecord(URL)
{
	day = new Date();
	id = day.getTime();
	eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=450,height=620,left = 0,top = 0');");
	return false;
}

function deleteRecord(id)
{
    reply=confirm("Do you really want to delete cashier report?");
    
    if (reply==true)
        window.location='index.php?report/delete/'+id;
}
...
function popUp(URL) 
{
	day = new Date();
	id = day.getTime();
	eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=1000,height=600,left = 0,top = 0');");
}
</script>