...
<tbody>
	...
	<tr height="20">
		<td class="dataLabel">Payment Period:</td>
...
<tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap>Delivery Date</td>
		<td scope="col" class="listViewThS1" nowrap>Date of Billing</td>
		<td scope="col" class="listViewThS1" nowrap>Amount Billed</td>
		<td scope="col" class="listViewThS1" nowrap>Currency</td>
		<td scope="col" class="listViewThS1" nowrap>Forex Rate</td>
		<td scope="col" class="listViewThS1" nowrap>Amount in USD</td>
		<td scope="col" class="listViewThS1" nowrap>Sched payment date</td>
		<td scope="col" class="listViewThS1" nowrap>Date of payment inst</td>
		<td scope="col" class="listViewThS1" nowrap>Actual payment date</td>
		<td scope="col" class="listViewThS1" nowrap>Amount paid in USD</td>
		<td scope="col" class="listViewThS1" nowrap>Balance in USD</td>
