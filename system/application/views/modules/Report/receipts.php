...
<form method="POST" action="index.php?report/receipts" >
...
<tbody>
	<tr height="20">
		<td scope="col" class="listViewThS1" nowrap width="250">Category</td>
		<td scope="col" class="listViewThS1" nowrap width="300">Item/Description</td>
		<td scope="col" class="listViewThS1" nowrap width="100"><div align="right">Qty Received</div></td>
	...
	<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
            ...
            align="left" valign="top"><span sugar="sugar0b">LATHE OPRN./VENEER PLANT</span></td>
            <td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
	...
	<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
			<td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
            align="left" valign="top"><span sugar="sugar0b">JOINTER/SPLICER</span></td>
    		<td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
	...
	<tr height="20">
    		<td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
           align="right" valign="top" colspan="2"><span sugar="sugar0b"><b>Total : </b></span></td>
            <td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
