<form method="POST" action="index.php?report/daily_sales_summary" >
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
<tbody>
	<tr height="20">
		<td class="dataLabel" width="100">Date </td>
		<td class="dataField" width="100"><input type="text" name="date" id="date" size="10" value="<?php echo $date ?>" /> <img id="jscal_trigger1" align="top" alt="Start Date" src="images/jscalendar.gif"/></td>
...
if (count($daquets)>0) {
?>
<input type="button" class="button" value="Print Now" onclick="return popUp('index.php?report/print_daily_sales_summary/<?php echo strtotime($date); ?>');" />
<?php
}
?>
</div>
...
function popUp(URL) 
{
	day = new Date();
	id = day.getTime();
	eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=1200,height=700,left = 0,top = 0');");
	return false;
}
