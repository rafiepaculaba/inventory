...
<tr>
	<td>
		<h4 class="dataLabel">&nbsp;&nbsp;<img src="images/submenu/politicalTag.gif" alt="Political Tag" border="0" align="top" /> Political Tag</h4>
	</td>
	<td align="right">
		<input type="button" class="button" value="Print"  onclick="popUp('index.php?dashboard/print_political');" />
	</td>
</tr>
</table>
