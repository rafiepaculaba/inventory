<form name="frmFilter" id="frmFilter" method="POST" action="index.php?vessel/show">
...
<tbody>
	<tr height="20">
		<td scope="col" class="listViewThS1" nowrap><a class="listViewThLinkS1" href="javascript: sorting('vesselCode');" />Vessel Code 
		<?php 
		if ($sortby=="vesselCode") {
		?>
			<img 
			<?php 
			if ($sortby=="vesselCode") {
		...
		<td scope="col" class="listViewThS1" nowrap><a class="listViewThLinkS1" href="javascript: sorting('vesselName');" />Vessel Name 
		<?php 
		if ($sortby=="vesselName") {
		?>
			<img 
			<?php 
			if ($sortby=="vesselName") {
	...
	<tr height="20" id="filters" style="display: none">
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="vesselCode" id="vesselCode" size="15" value="<?php echo $vesselCode ?>" /></td>
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="vesselName" id="vesselName" value="<?php echo $vesselName ?>" /></td>
	...
	?>
    	...
    	<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
            ...
            align="left" valign="top"><span sugar="sugar0b"><a href="index.php?vessel/view/<?php echo $row->vesselID ?>" class="listViewTdLinkS1"><?php echo $row->vesselCode ?></a></span></td>
    		
    		<td scope="row" 
            class="oddListRowS1" bgcolor="#ffffff" 
            align="left" valign="top"><span sugar="sugar0b"><a href="index.php?vessel/view/<?php echo $row->vesselID ?>" class="listViewTdLinkS1"><?php echo $row->vesselName ?></a></span></td>
    		
    		<td scope="row"
            class="oddListRowS1" bgcolor="#ffffff" 
    		align="left" valign="top"><span sugar="sugar0b"><a href="index.php?vessel/view/<?php echo $row->vesselID ?>" class="listViewTdLinkS1">
    		<?php 
    		if ($row->status=='1')
    			echo "Active";
    		else 
	...
	<tr>
		...
		<input type="image" class="button" name="cmdPrint" id="cmdPrint" value="Print" src="images/printer.png" title="Print"  onclick="return popUp('index.php?vessel/printlist/<?php echo $this->uri->segment(3); ?>');" />
		</div>
		</td>
...
<?php
if ($vesselCode || $vesselName || $status!='') {
