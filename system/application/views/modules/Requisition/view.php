<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdcancel" type="button" id="cmdcancel" value="SI Approve" onclick="window.location='index.php?requisition/view/2'" />
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
     <tr>
	     <th class="tabDetailViewDL" colspan="4" align="left"><h4 class="dataLabel">Requisition Order </h4></th>
	 </tr>
    <tr>
...
<tbody>
	...
	<tr height="20">
        ...
        <td scope="row" 
        class="oddListRowS1" bgcolor="#ffffff" 
        align="right" valign="top"><b>400.00</b></td>
