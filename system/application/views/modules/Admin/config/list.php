<form name="frmFilter" id="frmFilter" method="POST" action="index.php?config/show">
...
<tbody>
	<tr height="20">
		<td scope="col" class="listViewThS1" nowrap><a class="listViewThLinkS1" href="javascript: sorting('name');" />Config 
		<?php 
		if ($sortby=="name") {
		?>
			<img 
			...
			?>
			align="absmiddle" border="0" onclick="sorting('name');" /> 
		<?php 
		}
		?>
		</a>
		</td>
		<td scope="col" class="listViewThS1" nowrap><a class="listViewThLinkS1" href="javascript: sorting('value');" />Value 
		<?php 
		if ($sortby=="value") {
		?>
			<img 
	...
	<tr height="20" id="filters" style="display: none">
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="txtname" id="txtname" size="15" value="<?php echo $name ?>" maxlength="15" onkeypress="return keyRestrict1(event, 6);" /></td>
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="txtvalue" id="txtvalue" value="<?php echo $value ?>" maxlength="25" onkeypress="return keyRestrict1(event, 6);" /></td>
	...
	?>
    	...
    	<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
            ...
            align="left" valign="top"><span sugar="sugar0b"><a href="index.php?config/view/<?php echo $row->configID ?>" class="listViewTdLinkS1"><?php echo $row->name ?></a></span></td>
    		
    		<td scope="row" colspan="2"
            class="oddListRowS1" bgcolor="#ffffff" 
    		align="left" valign="top"><span sugar="sugar0b"><a href="index.php?config/view/<?php echo $row->configID ?>" class="listViewTdLinkS1"><?php echo $row->value ?></a></span></td>
    	</tr>
    	<tr>
    		<td colspan="20" height="1" class="listViewHRS1"></td>
    	</tr>
	...
	<tr>
		...
		<input type="image" class="button" name="cmdPrint" id="cmdPrint" value="Print" src="images/printer.png" title="Print"  onclick="return popUp('index.php?config/printlist/<?php echo $this->uri->segment(3); ?>');" />
		</div>
		</td>
