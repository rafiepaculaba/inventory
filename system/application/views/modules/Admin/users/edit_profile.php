<form method="post" name="frmEdit" id="frmEdit" action="index.php?user/update_profile" onsubmit="return check_form('frmEdit')" >

<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="submit" id="cmdSave" value=" Save "/>
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onClick="window.location='index.php?user/profile'" />
    </td>
...
<hr>
<h4 class="dataLabel">&nbsp;&nbsp;Edit Profile</h4>
<p>
...
<tr><td width="50%">
    ...
    <tr>
        <td class="dataLabel">User Group </td>
        <td class="dataField">
    ...
    <tr>
        ...
        <td class="dataField"><slot><input type="checkbox" name="isAdmin" id="isAdmin" value="1" disabled <?php if ($rec->isAdmin=="1") echo "checked" ?>/></slot></td>
    </tr>
     <tr>
        <td class="dataLabel" valign="top"><slot>Status </slot></td>
        <td class="dataField">
        <slot>
        <select name="rstatus" disabled>
...
<td width="50%">
    ...
    <tr>
        ...
        Module Tabs 
        <br>
        <select name="modules[]" id="modules[]" multiple size="9" disabled>
		<?php 
