 <table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="window.location='index.php?user/edit_profile';" />
...
<tr height="20">
	...
	<td scope="col" class="listViewThS1" width="50" nowrap><div align="center">Approve</div></td>
</tr>
<tr>
...
<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
    ...
    ?>
     name="chkAdd[]" disabled id="chk_<?php echo $ctr ?>" /></td>
    ...
    ?>
     name="chkView[]" disabled id="chk_<?php echo $ctr+1 ?>" /></td>
    ...
    ?>
     name="chkEdit[]" disabled id="chk_<?php echo $ctr+2 ?>" /></td>
    ...
    ?>
     name="chkDelete[]" disabled id="chk_<?php echo $ctr+3 ?>" /></td>
    ...
    ?>
     name="chkApprove[]" disabled id="chk_<?php echo $ctr+4 ?>" /></td>
</tr>
<tr>
    <td colspan="20" height="1" class="listViewHRS1"></td>
</tr>
		...
		if (!empty($row)) {
			...
			foreach($row as $sub) {
				...
				<tr onmouseover="setPointer(this, '0', 'over', '#ffffff', '#ebebed', '');" onmouseout="setPointer(this, '1', 'out', '#ffffff', '#ebebed', '');" onmousedown="setPointer(this, '0', 'click', '#ffffff', '#ebebed', '');" height="20">
			    	...
			    	?>
				     name="chkAdd[]" disabled id="chk_<?php echo $ctr+$i ?>" /></td>
			    	...
			    	?>
				     name="chkView[]" disabled id="chk_<?php echo $ctr+$i+1 ?>" /></td>
			    	...
			    	?>
				     name="chkEdit[]" disabled id="chk_<?php echo $ctr+$i+2 ?>" /></td>
			    	...
			    	?>
				     name="chkDelete[]" disabled id="chk_<?php echo $ctr+$i+3 ?>" /></td>
			    	...
			    	?>
				     name="chkApprove[]" disabled id="chk_<?php echo $ctr+$i+4 ?>" /></td>
				</tr>
				<tr>
				    <td colspan="20" height="1" class="listViewHRS1"></td>
				</tr>
...
if (!empty($report_privileges)) {
    ...
    ?>
     name="chkView[]" disabled id="chk_<?php echo $ctr ?>" /></td>
    <td scope="row" class="oddListRowS1" bgcolor="#ffffff" align="center" valign="top">&nbsp;</td>
    <td scope="row" class="oddListRowS1" bgcolor="#ffffff" align="center" valign="top">&nbsp;</td>
    <td scope="row" class="oddListRowS1" bgcolor="#ffffff" align="center" valign="top">&nbsp;</td>
	</tr>
	           ...
	           <div style="width: 100%; height:180px; overflow: auto;" id="divSectionList">
                ...
                <tbody>
                	<tr height="20">
                		...
                		<td scope="col" class="listViewThS1" width="40%" nowrap>Privileges</td>
