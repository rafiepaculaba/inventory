...
<tbody>
	<tr height="20">
		<td scope="col" class="listViewThS1" nowrap><a href="javascript: sorting('groupName');" />Group 
		<?php 
		if ($sortby=="groupName") {
		?>
			<img 
		...
		<td scope="col" class="listViewThS1" nowrap><a href="javascript: sorting('groupDesc');" />Description 
		<?php 
		if ($sortby=="groupDesc") {
		?>
			<img 
	...
	<tr height="20" id="filters" style="display: none">
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="groupName" id="groupName" size="15" value="<?php echo $groupName ?>" maxlength="15" onkeypress="return keyRestrict(event, 6);" /></td>
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="groupDesc" id="groupDesc" value="<?php echo $groupDesc ?>" maxlength="25" onkeypress="return keyRestrict(event, 6);" /></td>
