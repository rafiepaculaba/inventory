...
class Requisition extends Controller 
{
	...
	function submenu()
	{
		...
		$this->load->view("modules/Requisition/submenu");
		...
		$this->data['title']   = "Requisition Orders";
	...
	function create()
	{
		...
		if ($this->roles['create']) {
			...
			$this->load->view('modules/Requisition/tabs', $data);
			$this->load->view('modules/Requisition/create', $data);
	...
	function import()
	{
		...
		if ($this->roles['create']) {
			...
			$this->load->view('header', $data);
			$this->load->view('modules/Requisition/tabs', $data);
			$this->load->view('modules/Requisition/import', $data);
			$this->load->view('footer');
		} else {
			// error
			$data["display"] = "block";
	...
	function view($id = 0)
	{
		...
		if ($this->roles['view']) {
			...
			$this->load->view('modules/Requisition/tabs', $data);
			if ($id)
				$this->load->view('modules/Requisition/view'.$id, $data);
			else
				$this->load->view('modules/Requisition/view', $data);
			$this->load->view('footer');
		} else {
			// error
			$data["display"] = "block";
	...
	function view_approved($id = 0)
	{
		...
		if ($this->roles['view']) {
			...
			$this->load->view('header', $data);
			$this->load->view('modules/Requisition/tabs', $data);
			$this->load->view('modules/Requisition/view_approved', $data);
			$this->load->view('footer');
		} else {
			// error
			$data["display"] = "block";
	...
	function edit($id = 0)
	{
		...
		if ($this->roles['manage']) {
			...
			$this->load->view('header', $data);
			$this->load->view('modules/Requisition/tabs', $data);
			$this->load->view('modules/Requisition/edit', $data);
			$this->load->view('footer');
		} else {
			// error
			$data["display"] = "block";
	...
	function show()
	{
		...
		$this->load->view('header', $data);
		$this->load->view('modules/Requisition/tabs', $data);
		$this->load->view('modules/Requisition/list', $data);
		$this->load->view('footer');
	}
	...
	function printlist()
	{
		...
		$this->load->view('modules/Requisition/printlist', $data);
