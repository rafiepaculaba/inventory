...
class Payment extends Controller 
{
	...
	function submenu()
	{
		...
		$this->load->view("modules/Payment/submenu");
		...
		$this->data['title']   = "Payment Advices";
	...
	function create()
	{
		...
		if ($this->roles['create']) {
			...
			$this->load->view('modules/Payment/tabs', $data);
			$this->load->view('modules/Payment/create', $data);
	...
	function view($id = 0)
	{
		...
		if ($this->roles['view']) {
			...
			$this->load->view('modules/Payment/tabs', $data);
			if ($id)
				$this->load->view('modules/Payment/view'.$id, $data);
			else
				$this->load->view('modules/Payment/view', $data);
			$this->load->view('footer');
		} else {
			// error
			$data["display"] = "block";
	...
	function view_approved($id = 0)
	{
		...
		if ($this->roles['view']) {
			...
			$this->load->view('header', $data);
			$this->load->view('modules/Payment/tabs', $data);
			$this->load->view('modules/Payment/view_approved', $data);
			$this->load->view('footer');
		} else {
			// error
			$data["display"] = "block";
	...
	function edit($id = 0)
	{
		...
		if ($this->roles['manage']) {
			...
			$this->load->view('header', $data);
			$this->load->view('modules/Payment/tabs', $data);
			$this->load->view('modules/Payment/edit', $data);
			$this->load->view('footer');
		} else {
			// error
			$data["display"] = "block";
	...
	function show()
	{
		...
		$this->load->view('header', $data);
		$this->load->view('modules/Payment/tabs', $data);
		$this->load->view('modules/Payment/list', $data);
		$this->load->view('footer');
	}
	...
	function printlist()
	{
		...
		$this->load->view('modules/Payment/printlist', $data);
